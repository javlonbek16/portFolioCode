...
export default function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    const REACT_APP_SERVICEID = "service_wmcww1b"
    const REACT_APP_TEMPLATE = "template_2jdozz8"
    const REACT_APP_PUBLICKEY = "FySm6fupDB4FkWwyg"
        ...
        <div className="flex-auto w-80  flex flex-col justify-center text-center items-center  gap-1">
          ...
          <div data-aos={"slide-up"} className="text-center">
            ...
            <div className="text-white flex flex-row gap-7 w-fit mx-auto pt-4">
              <div
                onClick={() =>
                  window.open("https://github.com/javlonbek16", "_blank")
                }
              >
              ...
              <div
                onClick={() =>
                  window.open(
                    "https://www.instagram.com/mr_pain16/",
                    "_blank"
                  )
                }
              >
              ...
              <div
                onClick={() =>
                  window.open(
                    "https://www.linkedin.com/in/javlonbek-nematov-b581b3254/",
                    "_blank"
                  )
                }
              >
              ...
              <div
                onClick={() =>
                  window.open(
                    "https://www.facebook.com/profile.php?id=100090571937516",
                    "_blank"
                  )
                }
              >
